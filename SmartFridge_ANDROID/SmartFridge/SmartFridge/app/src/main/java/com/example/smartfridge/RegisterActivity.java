...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*// AÑADIMOS 2 USUARIOS POR DEFECTO
        UserManager.addUser(new User("administrador", "administrador", "admin@edu.uah.es", "None"));
        UserManager.addUser(new User("Daniel", "Daniel1", "daniel@edu.uah.es", "None"));
*/
